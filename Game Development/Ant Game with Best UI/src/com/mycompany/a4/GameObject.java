...
//	}
	...
	public Point getLocation() {
		return new Point(myTranslation.getTranslateX(), myTranslation.getTranslateY());
	}
...
//	}
	...
	public boolean collidesWith(GameObject obj) {
		...
		float t1 = this.getLocation().getY() + s1/2;
		float b1 = this.getLocation().getY() - s1/2;
		float l1 = this.getLocation().getX() - s1/2;
		float r1 = this.getLocation().getX() + s1/2;
		
		//get corners of other object
		int s2 = obj.size;
		
		float t2 = obj.getLocation().getY() + s2/2;
		float b2 = obj.getLocation().getY() - s2/2;
		float l2 = obj.getLocation().getX() - s2/2;
		float r2 = obj.getLocation().getX() + s2/2;
